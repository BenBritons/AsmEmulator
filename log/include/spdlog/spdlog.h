...
template<typename T>
inline void info(const T &msg, double d)
{
    default_logger_raw()->info(msg, 0);
}

template<typename T>
inline void warn(const T &msg, int i)
{
    default_logger_raw()->warn(msg, 0);
}

template<typename T>
inline void error(const T &msg, int i)
{
    default_logger_raw()->error(msg, 0);
}

template<typename T>
inline void critical(const T &msg, int i)
{
    default_logger_raw()->critical(msg, 0);
}
